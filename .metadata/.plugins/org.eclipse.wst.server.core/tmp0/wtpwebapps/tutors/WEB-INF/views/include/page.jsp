...
<!-- 이전/처음 -->
	...
	<a class="page_prev" title="이전" onclick="go_page(${page.beginPage - page.blockPage})">이전</a><!-- 이전블럭첫페이지 이동 -->	
	<%-- <a class="page_prev" title="이전" onclick="go_page(${page.beginPage - 1})">이전</a><!-- 이전블럭마지막페이지 이동 --> --%>
	</c:if>	
